                    ...
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a href="{{ asset('template/index.html')}}"><i class="ik ik-home"></i></a>
                            </li>
                            <li class="breadcrumb-item">
                                <a href="#">Doctors</a>
                            </li>
                        ...
                        <table id="data_table" class="table">
                            ...
                            @if (count($users) > 0)
                                @foreach($users as $doctor)
                                    <tr>
                                        <td>{{ $doctor->name }}</td>
                                        <td><img src="{{ asset('images/' . $doctor->image)}}" class="table-doctor-thumb"
                                                 alt="" width="100"></td>
                                        <td>{{ $doctor->email }}</td>
                                        ...
                                        <td>
                                            <div class="table-actions">
                                                ...
                                                <a href="{{ route('doctor.show', $doctor) }}"><i class="ik ik-trash-2"></i></a>
                                            </div>
                                        </td>
                                        <td></td>
                                    </tr>
