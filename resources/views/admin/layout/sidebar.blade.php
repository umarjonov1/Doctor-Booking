...
{{--                    </div>--}}
                    ...
                    <div class="nav-item has-sub">
                        ...
                        <div class="submenu-content">
                            ...
                            <a href="{{ route('appointment.index')}}" class="menu-item">Check time</a>
                        </div>
                    </div>
                    <div class="nav-lavel">UI Element</div>
                    <div class="nav-item has-sub">
                        <a href={{ asset('template/#')}}><i class="ik ik-box"></i><span>Basic</span></a>
                        <div class="submenu-content">
                    ...
                    <div class="nav-item has-sub">
                        <a href={{ asset('temlate/#')}}><i class="ik ik-gitlab"></i><span>Advance</span> <span class="badge badge-success">New</span></a>
                        <div class="submenu-content">
                    ...
                    <div class="nav-item has-sub">
                        <a href={{ asset('template/#')}}><i class="ik ik-edit"></i><span>Forms</span></a>
                        <div class="submenu-content">
                    ...
                    <div class="nav-item has-sub">
                        <a href={{ asset('temlate/#')}}><i class="ik ik-pie-chart"></i><span>Charts</span> <span class="badge badge-success">New</span></a>
                        <div class="submenu-content">
                    ...
                    <div class="nav-item has-sub">
                        <a href={{ asset('template/#')}}><i class="ik ik-lock"></i><span>Authentication</span></a>
                        <div class="submenu-content">
                            <a href="{{ asset('template/pages/login.html')}}" class="menu-item">Login</a>
                            <a href="{{ asset('template/pages/register.html')}}" class="menu-item">Register</a>
                            <a href="{{ asset('template/pages/forgot-password.html')}}" class="menu-item">Forgot Password</a>
                        </div>
                    </div>
                    <div class="nav-item has-sub">
                        <a href={{ asset('template/#')}}><i class="ik ik-file-text"></i><span>Other</span></a>
                        <div class="submenu-content">
                            <a href="{{ asset('template/pages/profile.html')}}" class="menu-item">Profile</a>
                            <a href="{{ asset('template/pages/invoice.html')}}" class="menu-item">Invoice</a>
                        </div>
                    </div>
                    <div class="nav-item">
                        <a href="{{ asset('template/pages/layouts.html')}}"><i class="ik ik-layout"></i><span>Layouts</span><span class="badge badge-success">New</span></a>
                    </div>
